...
void reply_query(int fd, int family, time_t now)
{
  ...
  if (daemon->server_fuzz_file)
  {
	  ...
	  my_frec->sentto = (struct frec*)malloc(sizeof(struct server));
	  forward = my_frec;
  }
  else
#endif
